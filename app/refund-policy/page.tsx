  ...
  return (
    <LegalPageLayout title="환불정책">
      <div className="space-y-10 leading-8 text-sm md:text-base">
        <p>
          주다고 기준봉 센터에서 판매하는 전자책은 PDF 등 디지털 형태로 제공되는
          디지털콘텐츠입니다. 구매 취소 및 환불은 아래 기준과 관련 법령에 따라
          처리됩니다.
        </p>
        ...
        <section>
          ...
          <p>
            구매 신청 후 아직 대금을 입금하지 않은 경우 별도의 환불 절차 없이
            주문을 취소할 수 있습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-4">
            전자책은 PDF 등 복제가 가능한 디지털콘텐츠의 특성을 가지고 있습니다.
          </p>

          <p className="mb-4">
            전자책의 제공 또는 이용이 개시된 이후에는 관련 법령에서 정한 요건에
            따라 청약철회 및 환불이 제한될 수 있습니다.
          </p>

          <p>
            청약철회가 제한되는 경우에는 구매 전에 해당 사실을 구매자가 쉽게
            확인할 수 있도록 안내합니다.
          </p>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-2">
            <li>
              본 상품은 PDF 등 디지털 형식으로 제공되는 디지털콘텐츠입니다.
            </li>

            <li>
              전자책의 제공 또는 이용이 시작된 이후에는 관련 법령에 따라 단순
              변심에 의한 환불이 제한될 수 있습니다.
            </li>

            <li>
              본 전자책은 주식 교육용 콘텐츠이며 특정 종목의 매수·매도 추천,
              투자자문 또는 수익 보장을 의미하지 않습니다.
            </li>
            ...
            <li>
              전자책 파일의 무단 복제, 공유, 배포, 판매 및 재판매는 금지됩니다.
            </li>
          </ol>
        </section>
